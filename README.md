...
*   **Counterfactual Explanations**: "신용점수가 50점 더 높았다면?"과 같은 반사실적 설명을 통해 개선 팁을 제공하고, 이를 **구체적인 미션으로 연결**하여 행동을 유도.
...
단순한 재미를 넘어, 사용자가 **금융 건전성을 개선하고 더 좋은 대출 조건(금리 인하, 한도 상향)을 달성할 수 있도록 유도**하는 동기 부여 시스템입니다.
